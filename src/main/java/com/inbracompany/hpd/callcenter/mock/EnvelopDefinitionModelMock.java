package com.inbracompany.hpd.callcenter.mock;

//@Repository
//public class EnvelopDefinitionModelMock {
//	
//
//	
//	@Autowired EnvelopeMessageModel envelope;
//	
//	public EnvelopeMessageModel getIEnvelopeMessageModelMock() throws NoSuchAlgorithmException, IOException {
//
//
...
//				"/Users/jbjares/workspaces/model-design-by-commandline/inbraBigDataSDKClient/src/test/resources/messagedefinition/build.sh"));
...
//		rdPyScript.setExtension(".py");
//		rdPyScript.setChecksum(TrainFileUtiuls.getChecksum(
//				"/Users/jbjares/workspaces/model-design-by-commandline/inbraBigDataSDKClient/src/test/resources/messagedefinition/script.py"));
//		rdPyScript.setTestEnviroment("python -v");
//		rdPyScript.setType("py_script");
//		rdPyScript.setVersion("1.0.0");
//		rdPyScript.setChildsDigitalObjID(Collections.EMPTY_LIST);
...
//		cqlScript.setExtension(".py");
//		cqlScript.setChecksum(TrainFileUtiuls.getChecksum(
//				"/Users/jbjares/workspaces/model-design-by-commandline/inbraBigDataSDKClient/src/test/resources/messagedefinition/input.cql"));
//		cqlScript.setTestEnviroment("curl 'http://localhost:8080/DiagnosticOrder' \\\n"
//				+ "     -H 'Authorization: Basic Y2xpZW50OnNlY3JldA=='");
//		cqlScript.setType("cql_script");
//		cqlScript.setVersion("1.0.0");
...
//		requirementScript.setExtension(".txt");
//		requirementScript.setChecksum(TrainFileUtiuls.getChecksum(
//				"/Users/jbjares/workspaces/model-design-by-commandline/inbraBigDataSDKClient/src/test/resources/messagedefinition/requirements.txt"));
//		requirementScript.setTestEnviroment("pip -v");
//		requirementScript.setType("requirement_script");
//		requirementScript.setVersion("1.0.0");
//		rdPyScript.setChildsDigitalObjID(Collections.EMPTY_LIST);
...
//		responseDefinition1.setVagonPosition("res_1");
...
//		responseDefinition2.setVagonPosition("res_2");
