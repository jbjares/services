...
@Repository
public interface IConsultaRepository extends CrudRepository<ConsultaModel, String>, QueryByExampleExecutor<ConsultaModel>  {
	...
	List<ConsultaModel> findAllByContext(String context);
